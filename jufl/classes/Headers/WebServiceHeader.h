...
#define kChatInitiate @"chatInitiate"
...
#define kOtherNotification @"otherNotification"
#define kChatTypeStatus @"group_status"
#define kChatEventName @"event_name"
#define kChatSenderName @"sender_name"

#define kPushChatTag 8
#define kPushVersionTag 9
...
// NSString *strURL=[NSString stringWithFormat:@"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=%f,%f&rankby=distance&name=%@&key=AIzaSyB0EAoRACMQPUoiPheg-nKQi3cJx6Ot1MI",coord.latitude,coord.longitude,name];

#define kGoogleApiKey                       @"AIzaSyB0EAoRACMQPUoiPheg-nKQi3cJx6Ot1MI"

#define kGoogleAutocompleteAPI              @"autocomplete/json?"
#define kGooglePlaceDetailsAPI              @"details/json?"
#define kGoogleNearbySearchAPI              @"nearbysearch/json?"
#define kGoogleSearchTextAPI                @"textsearch/json?"
#define kGooglePlacePhotoAPI                @"photo?"

#define kGoogleLatLong [NSString stringWithFormat:@"%f,%f",[Location sharedInstance].userCurrentLocation.latitude,[Location sharedInstance].userCurrentLocation.longitude]
