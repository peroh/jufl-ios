...
NSString *const kLatestChatTime = @"lastChatTime";
...
- (instancetype)initWithChatListDictionary:(NSDictionary *)dict {
    ...
    if (self && [dict isKindOfClass:[NSDictionary class]]) {
        ...
        if ([self objectOrNilForKey:kLatestChatTime fromDictionary:dict]) {
             self.lastChatDateTime = [NSDate dateWithTimeIntervalSince1970:[[self objectOrNilForKey:kLatestChatTime fromDictionary:dict] doubleValue]];
        }
        else{
            self.lastChatDateTime = nil;
        }
