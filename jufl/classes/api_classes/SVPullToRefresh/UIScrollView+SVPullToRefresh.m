...
//        UIImageView *imageView = [NRAnimations animateImageViewWithImages:LoaderImages];
//        [imageView setSize:CGSizeMake(30, 30)];
//        //imageView.frame.size = CGSizeMake(20, 20);
//        [view setCustomView:imageView forState:SVPullToRefreshStateAll];
