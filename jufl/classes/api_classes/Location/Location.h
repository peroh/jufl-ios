...
@property(nonatomic,copy)  void(^ reverseGeocodeBlock)(CLPlacemark *);
@property CLLocationCoordinate2D userCurrentLocation;
...
-(void)getAddressInfoFromLocationLatitude:(double)latCord longitude:(double)longCord completionBlock:(void(^)(CLPlacemark * placeMark))block;
