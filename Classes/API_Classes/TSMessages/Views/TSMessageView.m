...
#define TSMessageViewPadding 8.0
...
canBeDismissedByUser:(BOOL)dismissingEnabled
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = Rgb2UIColor(33, 205, 182);//[UIColor colorWithHexString:current[@"backgroundColor"]];
        ...
        if (image) self.textSpaceLeft += 60 + 1 * TSMessageViewPadding;
...
//        }
        [self.titleLabel setFont:FONT_ProximaNova_Light_WITH_SIZE(16.0)];
...
//            }
            [self.contentLabel setFont:FONT_ProximaNova_Light_WITH_SIZE(14.0)];
...
//            [self.contentLabel setShadowOffset:self.titleLabel.shadowOffset];
        ...
        if (image)
        {
            ...
            [Utils makeImageCircular:_iconImageView];
...
- (CGFloat)updateHeightOfMessageView
{
    ...
    if ([self.subtitle length])
    {
        self.contentLabel.frame = CGRectMake(self.textSpaceLeft,
                                             self.titleLabel.frame.origin.y + self.titleLabel.frame.size.height-4.0 ,
                                             screenWidth - TSMessageViewPadding - self.textSpaceLeft - self.textSpaceRight,
                                             21.0);
