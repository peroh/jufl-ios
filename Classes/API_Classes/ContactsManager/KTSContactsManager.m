...
@interface KTSContactsManager ()<UIAlertViewDelegate>
...
- (void)importContacts:(void (^)(NSArray *))contactsHandler
{
    ...
    {
//        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Address Book Access Denied" message:@"Please grant us access to your Address Book" delegate:self cancelButtonTitle:@"OK" otherButtonTitles:@"Settings",nil];
//        [alert show];
        contactsHandler(nil);
        return;
    }
...
//                UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Address Book Access Denied" message:@"Please grant us access to your Address Book in Settings -> Privacy -> Contacts" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
//                [alert show];
...
- (NSMutableArray *)extractContactsInDictionary:(NSMutableArray *)contactsList extractOptions:(KTSContactsManagerField)fields
{
    ...
    [contactsList enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
        ...
        if (KTSContactsManagerFieldImage & fields){
            ...
            if (data){
                person[@"imageData"] = [UIImage imageWithData:data];
            }            
        }
