...
#define TEXTVIEW_INSETS     (IS_IPAD ? UIEdgeInsetsMake(30, 30, 30, 30) : UIEdgeInsetsMake(30, 15, 15, 15))
           ...
           textViewInsets:(UIEdgeInsets)textViewInsets
{
    ...
    if (self) {
        ...
        if (buttonStyle == YIPopupTextViewButtonStyleRightDone ||
            ...
            if (!doneButtonColor) {
                doneButtonColor = [UIColor colorWithRed:33.0/255.0 green:205.0/255.0 blue:182.0/255.0 alpha:1]; // #449922
            }
